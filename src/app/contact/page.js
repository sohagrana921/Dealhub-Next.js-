  ...
  return (
    <div className="mt-28">
      <div className="my-container">
        <div>
          <h2 className="text-xl md:text-3xl xl:text-4xl font-semibold xl:font-bold xl:tracking-wide xl:leading-snug capitalize text-title-color">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-4">
            <div className="p-6 border-[1px] border-gray-3 w-full">
              <div className="flex gap-3 items-center pb-1 lg:pb-3 cursor-pointer">
                ...
                <h4 className="text-base lg:text-lg font-medium uppercase text-my-primary">
        ...
        <div className="my-16">
          <div className="flex justify-between gap-10">
            <div className="w-full hidden  md:block">
              <h2 className="text-xl md:text-3xl xl:text-4xl font-medium md:font-semibold xl:font-bold xl:tracking-wide capitalize text-title-color mb-5">
                Get in touch
              </h2>
              <p className="text-gray-5 text-sm lg:text-base xl:leading-7 text-justify lg:text-start">
                We are collaborating with some of the largest brands in the
          ...
          <div className="flex flex-col  md:flex-row justify-between items-center gap-10">
            <div className="w-full space-y-6">
              <div className="md:hidden">
                <h2 className="text-4xl font-bold mb-3 lg:mb-5">
                  Get in touch
                </h2>
              ...
              <div>
                <div className="flex gap-5 items-center">
                  ...
                  <div className="hover:text-my-primary">
                    <h4 className=" uppercase text-base lg:text-lg font-semibold transition delay-150 duration-300 ease-in-out">
                      address
                    </h4>
                    <p className="text-gray-5 text-sm lg:text-base">
